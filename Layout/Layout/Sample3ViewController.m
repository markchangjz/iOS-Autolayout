...
- (void)viewDidLoad {
	...
	NSArray *horizontalConstraints =[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-20-[redView(==50)]-20-[greenView]-20-[blueView]-20-|" options:0 metrics:nil views:views];
	NSArray *equalWidthConstraints2 = [NSLayoutConstraint constraintsWithVisualFormat:@"H:[greenView(==blueView)]" options:0 metrics:nil views:views];
