...
class MainTableViewController: UITableViewController {
	...
	override func viewDidLoad() {
		...
		viewControllers = ["Corner", "Center", "Stack View", "Basic", "Three views resizes with equal width", "Three view resizes in ratio 1:2:4", "Fixed size constraint & equal width", "Fixed widths & center view resizes", "Rotate", "Safe Area - Bottom View", "Layout Guide"]
	}
	...
	override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
		if indexPath.row == 0 {
            ...
            let layoutGuideVC = LayoutGuideViewController()
            navigationController?.pushViewController(layoutGuideVC, animated: true)
        }
	}
}
